          ...
          <div className='about__container bd-grid'>
            <div className='about__data'>
              <p className='about__description'>
                Eu tenho 20 anos e foco em desenvolvimento backend usando Node e
                a stack JavaScript/TypeScript e trabalho também com frameworks
                de frontend. Abaixo tu vai ver mais sobre as tecnologias que eu
                trabalho.
              </p>
            ...
            <div>
              <div className='about__information'>
                ...
                <div className='about__information-data'>
                  ...
                  <span>+55 (11) 98688-2668</span>
                </div>
                <div className='about__information-data'>
                  <i className='bx bx-envelope about__information-icon' />
                  <span>gustta00@icloud.com</span>
                </div>
              </div>
